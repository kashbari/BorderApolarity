...
<<<<<<< HEAD
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_63 = Integer(63); _sage_const_4 = Integer(4)
=======
...
def border_apolarity_110(T,reps,C,r,k):
	with open("sl3rk15res{}_0.txt".format(k),'w') as ff:
